...
namespace BangBank.Modelos
{
    ...
    public class ContaCorrente
    {
        ...
        /// </summary>
        /// <param name="agencia">Representa o valor da Propriedade <see cref="Agencia"/> Agencia e deve ter um valor maior que Zero.</param>
        /// <param name="numero">Representa o valor da Propriedade <see cref="Numero"/> Número e deve ter um valor maior que Zero.</param>
        ...
        /// <summary>
        /// Realiza o sque e atualiza o valor da propriedade <see cref="Saldo"/>
        /// </summary>
